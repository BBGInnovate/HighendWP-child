...
var COLOR_FREE = "#B9CCD3";
var COLOR_PARTIALLY_FREE = "#72777A";
var COLOR_NOT_FREE = "#102F53";
	...
	jQuery(document).ready(function() {
		...
		for (var i = 0; i < threats.length; i++) {
			...
			var img = {
				...
				// svgPath: targetSVG, scale: targetSVGScale, 
				// zoomLevel: 5,	//if you want it to zoom when you click a marker, enable this
				imageURL: "http://2016.bbg.gov/wp-content/themes/HighendWP-child/img/map-pin-red.png",
				width:16,
				height:16,
				selectable:false,
				latitude: t.latitude,
